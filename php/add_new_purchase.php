...
//          $result = mysqli_query($con, $query);
//          if($result)
//              echo "Medicine Stock saved...";
//          else
//              echo "Failed to save Medicine Stock!";
//      }
  }
...
<!--          <input type="text" class="form-control" placeholder="Medicine Name" name="medicine_name">-->
      ...
      <div class="row col col-md-8">
        <div class="col col-md-3"><label for="generic_name" class="font-weight-bold">&nbsp;Generic Name : </label></div>
